...
class Config(object):
    API_ID = int(os.getenv("API_ID", "26409115"))
    API_HASH = os.getenv("API_HASH", "c2ed7af046020624f497973cf4df97fd")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6169394086:AAH3uGA9cNvJbR8fp1papAJYnZKu9uXJ-uI")
    ...
    BOT_USERNAME = os.getenv("BOT_USERNAME", "AKmovieschurchbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "6019668674"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "N2amovie")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "akbacup")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001654853018")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://postbot:postbot@cluster0.ouwne8q.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001645022040"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "AKLOVE")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ https://t.me/backup429 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
